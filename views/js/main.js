...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    //function. Moved lines out of for loop that only needed one call to
    //configure varibles for calculations.
    var pizzaVar = document.getElementsByClassName("randomPizzaContainer");
...
function updatePositions() {
  ...
  //removed document.body.scrollTop from loop by creating a seperate varible.
